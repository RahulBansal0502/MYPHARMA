...
f.setDefaultCloseOperation(f.EXIT_ON_CLOSE);
        ...
        l5.setBounds(150,220,150,30);
        l5.setFont(new Font("serif",Font.BOLD,20));
        l6.add(l5);

        t5=new JTextField();
        t5.setBounds(350,220,200,30);
        l6.add(t5);
        ...
        t7=new JTextField();
        t7.setBounds(350,270,200,30);
        l6.add(t7);
        
        l9= new JLabel("PIN Code");
        l9.setBounds(150,320,150,30);
        l9.setFont(new Font("serif",Font.BOLD,20));
        l6.add(l9);
        
        t9=new JTextField();
        t9.setBounds(350,320,200,30);
        l6.add(t9);

        b = new JButton("Add Shop");
        b.setBackground(Color.BLACK);
        b.setForeground(Color.WHITE);
        b.setBounds(180,370,150,30);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
                Conn cc = new Conn();
                String q = "insert into shop values('"+c+"','"+a+"','"+bb+"','"+g+"','"+i+"','"+e+"');";
