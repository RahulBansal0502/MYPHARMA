    ...
    Dashboard(String id)
    {
      ...
      ownerid=id;
        ...
        b1.setFont(new Font("Arial", Font.BOLD, 20));
         b1.setBounds(25,150,200,30);
         b1.addActionListener(this);
  
         b2.setFont(new Font("Arial", Font.BOLD, 20));
         b2.setBounds(25,200,200,30);
...
{
        //  Front f = new
        Dashboard d = new Dashboard("sam1234");
}
}
